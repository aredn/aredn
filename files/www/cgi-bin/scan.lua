...
if autoscan then
    html.print("<meta http-equiv='refresh' content='5;url=/cgi-bin/scan.lua'>")
end
html.print([[
    ...
    <body><form method=post action=/cgi-bin/scan.lua enctype='multipart/form-data'>
    <center>
]])
...
html.print("&nbsp;&nbsp;&nbsp;")
html.print("<button type=button onClick='window.location=\"status.lua\"' title='Return to status page'>Quit</button><br><br>")
