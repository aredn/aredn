...
local snr_run_avg = 0.4 -- snr running average
local tx_quality_run_avg = 0.4 -- tx quality running average
local ping_timeout = 1.0 -- timeout before ping gives a qualtiy penalty
local ping_time_run_avg = 0.4 -- ping time runnng average
local bitrate_run_avg = 0.4 -- rx/tx running average
